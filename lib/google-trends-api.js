...
/***/ function(module, exports, __webpack_require__) {
	...
	function formatKeywords(obj) {
	  ...
	  if (Array.isArray(obj.keyword)) {
	    ...
	    obj.keyword.reduce(function (keyword) {
	      // Add the keyword to the array
	      comparisonItems.push([].concat(_toConsumableArray(obj), [keyword]));
	    }, []);
	  }
	...
	function getResults(searchType, obj) {
	  ...
	  var comparisonItem = formatKeywords(obj);
	  ...
	  var options = {
	    ...
	    qs: {
	      hl: obj.hl,
	      req: JSON.stringify({ comparisonItem: comparisonItem, cat: 0 }),
	      tz: 300
	    }
	  };
